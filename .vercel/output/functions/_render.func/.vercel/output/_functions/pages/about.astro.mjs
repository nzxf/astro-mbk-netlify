...
import 'kleur/colors';
import { $ as $$MainLayout } from '../chunks/MainLayout_C97uDrMG.mjs';
import { $ as $$Image } from '../chunks/_astro_assets_CnC8qWTO.mjs';
...
const about = new Proxy({"src":"/_astro/about.C1FZ3Rbp.jpg","width":6000,"height":4000,"format":"jpg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-netlify/src/images/about.jpg";
							}
...
const team1 = new Proxy({"src":"/_astro/team1.CHXq7Isr.png","width":750,"height":500,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-netlify/src/images/team1.png";
							}
...
const team2 = new Proxy({"src":"/_astro/team2.Ccx9qtIf.png","width":750,"height":500,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-netlify/src/images/team2.png";
							}
...
const team3 = new Proxy({"src":"/_astro/team3.B0njnFun.png","width":750,"height":500,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-netlify/src/images/team3.png";
							}
...
}, "/home/zan/Code/astro-mbk-netlify/src/pages/about.astro", void 0);

const $$file = "/home/zan/Code/astro-mbk-netlify/src/pages/about.astro";
const $$url = "/about";
